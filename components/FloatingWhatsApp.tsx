...
export default function FloatingWhatsApp() {
  ...
  if (pathname?.startsWith('/briefing') || pathname?.startsWith('/raio-x') || pathname?.startsWith('/proposta') || pathname?.startsWith('/contrato') || pathname?.startsWith('/ferramentas')) return null
  return (

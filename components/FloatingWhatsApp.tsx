...
export default function FloatingWhatsApp() {
  ...
  const whatsappMessage = "Olá, vim pelo site da ORIUM e gostaria de saber mais sobre estruturação digital."
  const whatsappLink = `https://wa.me/5531999352065?text=${encodeURIComponent(whatsappMessage)}`
  return (
    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp" className="fixed bottom-4 right-4 z-50 transition duration-300 hover:-translate-y-1 hover:scale-105 md:bottom-8 md:right-8">

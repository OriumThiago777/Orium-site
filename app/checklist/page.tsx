...
function ChecklistContent() {
  ...
  async function handleSalvarEGerarPDF() {
    ...
    try {
      ...
      const periodoTexto = periodo ? periodo.toUpperCase() : ''
      ...
      coverEl.innerHTML = `
        <div style="${P2}width:794px;height:1123px;position:relative;overflow:hidden;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:80px;box-sizing:border-box;">
          ...
          <div style="position:relative;z-index:1;text-align:center;">
            <div style="color:#FF6B00;font-size:11px;letter-spacing:8px;text-transform:uppercase;margin-bottom:24px;font-weight:600;${P2}">CHECKLIST DE ENTREGA</div>
          ...
          <div style="position:absolute;bottom:54px;z-index:1;"><div style="color:rgba(255,255,255,0.12);font-size:9px;letter-spacing:3px;text-transform:uppercase;${P2}">ORIUM™ · CHECKLIST DE ENTREGAS</div></div>
        </div>
      `

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className={primaryButton}>
                  Falar com a ORIUM
                </a>
        ...
        <section
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <ServiceCard title="Branding" description="Construção de posicionamento, identidade visual e percepção premium para marcas locais." />
              <ServiceCard title="Sites" description="Landing pages e estruturas digitais modernas focadas em conversão e presença profissional." />
              <ServiceCard title="Automação" description="Sistemas, formulários, integrações e automações para aumentar capacidade operacional." />
            </div>
          </div>
        </section>
      </Reveal>
        ...
        <section className="relative overflow-hidden bg-zinc-950 text-white py-20 md:py-32 border-t border-zinc-900">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="rounded-2xl border border-zinc-800 bg-black/70 px-5 py-4 backdrop-blur-sm">
                <h3 className="text-base font-bold mb-1">Posicionamento</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Clareza sobre como a marca deve ser percebida pelo público.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-black/70 px-5 py-4 backdrop-blur-sm">
                <h3 className="text-base font-bold mb-1">Percepção premium</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Design, linguagem e presença visual alinhados a valor.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-black/70 px-5 py-4 backdrop-blur-sm">
                <h3 className="text-base font-bold mb-1">Operação digital</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Estruturas, páginas e automações para reduzir improviso.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-black/70 px-5 py-4 backdrop-blur-sm">
                <h3 className="text-base font-bold mb-1">Crescimento sustentável</h3>
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Presença digital pensada para gerar continuidade, não apenas volume.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-black text-white py-20 md:py-32 border-t border-zinc-900">
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <ProcessStep number="1" title="Diagnóstico" description="Entendemos o momento da marca, seus objetivos, posicionamento atual e principais gargalos digitais." />
              <ProcessStep number="2" title="Estratégia" description="Definimos a direção visual, narrativa, comunicação e prioridades para fortalecer a percepção da marca." />
              <ProcessStep number="3" title="Estrutura" description="Organizamos perfil, conteúdo, páginas, automações e materiais para criar uma presença mais profissional." />
              <ProcessStep number="4" title="Execução" description="Colocamos a estrutura em prática com entregas consistentes, ajustes e melhoria contínua." />
            </div>
          </div>
        </section>
      </Reveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="group relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-950/80 p-6 md:p-8 transition duration-300 hover:-translate-y-2 hover:border-orange-500/70 hover:shadow-2xl hover:shadow-orange-500/10">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-orange-500 text-sm uppercase tracking-widest font-semibold mb-4">Barbearia</p>
                  <h3 className="text-2xl md:text-3xl font-bold mb-4">Altemans Barbearia</h3>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Social Media</span>
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Direção Visual</span>
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Conteúdo</span>
                  </div>
                  <div className="mt-8 flex flex-col sm:flex-row gap-3">
                    <a href="https://www.instagram.com/altemansbarbearia/" target="_blank" rel="noopener noreferrer" className={secondaryButton}>Ver Instagram</a>
                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className={primaryButton}>Quero algo parecido</a>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-950/80 p-6 md:p-8 transition duration-300 hover:-translate-y-2 hover:border-orange-500/70 hover:shadow-2xl hover:shadow-orange-500/10">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-orange-500 text-sm uppercase tracking-widest font-semibold mb-4">Saúde e educação</p>
                  <h3 className="text-2xl md:text-3xl font-bold mb-4">Prof. Marcelo Félix</h3>
                  <p className="text-zinc-400 leading-relaxed mb-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Branding</span>
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Autoridade</span>
                    <span className="rounded-full border border-zinc-700 bg-black/50 px-4 py-2 text-sm text-zinc-300">Posicionamento</span>
                  </div>
                  <div className="mt-8 flex flex-col sm:flex-row gap-3">
                    <a href="https://www.instagram.com/prof.marcelofelix/" target="_blank" rel="noopener noreferrer" className={secondaryButton}>Ver Instagram</a>
                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className={primaryButton}>Quero algo parecido</a>
                  </div>
                </div>
              </div>
      ...
      <Reveal delay={0.4}>
        ...
        >
          <div className="absolute inset-0">
            <Image src="/cta.jpg" alt="CTA ORIUM" fill sizes="100vw" className="object-cover opacity-20" />
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className={primaryButton}>Falar no WhatsApp</a>
              <a href="#projetos" className={secondaryButton}>Ver Projetos</a>
            </div>
          </div>
        </section>
      </Reveal>
      ...
      <footer className="bg-black text-zinc-500 border-t border-zinc-900 py-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-6 text-sm">
            <a href="https://www.instagram.com/orium.agc/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition">Instagram</a>
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition">WhatsApp</a>
            <a href="#contato" className="hover:text-orange-500 transition">Contato</a>
          </div>
          <p className="text-sm">© 2026 ORIUM. Todos os direitos reservados.</p>
        </div>
      </footer>
    </>
  );
